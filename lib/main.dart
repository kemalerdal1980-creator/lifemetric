          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Gizlilik & Çağrı Kalkanı', style: TextStyle(fontSize: 19, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87)),
                  Text('Arayanları maskele ve istenmeyen numaraları engelle', style: TextStyle(color: isDark ? const Color(0xFF9CA3AF) : Colors.grey[600], fontSize: 11)),
                ],
              ),
            ),
          ],
    ...
    return ListView(
      ...
      children: [
        ...
        if (_isWrappedReset)
          ...
          _buildWrappedCard(
            title: 'Detaylı Ekran Süresi',
            mainStat: '4 Sa 12 Dk / Günlük Ortalama',
            icon: Icons.smartphone,
            color: const Color(0xFFF59E0B),
            isDark: isDark,
            child: Column(
              children: [
                _buildDetailRow(Icons.video_library, 'YouTube & Yayın', '1 Sa 20 Dk / Gün (%32)', isDark),
                _buildDetailRow(Icons.camera_alt_outlined, 'Instagram & Sosyal Medya', '1 Sa 05 Dk / Gün (%26)', isDark),
                _buildDetailRow(Icons.work_outline, 'İş & Verimlilik (Excel/Mail)', '55 Dk / Gün (%22)', isDark),
                _buildDetailRow(Icons.message_outlined, 'Mesajlaşma & İletişim', '52 Dk / Gün (%20)', isDark),
              ],
            ),
          ),
          _buildWrappedCard(
            title: 'Günlük Rutin & Konum Analizi',
            mainStat: 'Bluetooth & Hücresel Sinyal Geçmişi',
            icon: Icons.location_on_rounded,
            color: const Color(0xFFEC4899),
            isDark: isDark,
            child: Column(
              children: [
                _buildDetailRow(Icons.business, '08:00 - 17:30', 'İşyeri / Ofis (Ağ: Keskinkılıç_Corp_Wi-Fi)', isDark),
                _buildDetailRow(Icons.directions_bus, '17:30 - 18:15', 'Ulaşım / Transit Sinyal Tespiti', isDark),
                _buildDetailRow(Icons.home, '18:15 - 07:30', 'Ev (Bluetooth: Ayşin_Home_Net)', isDark),
                _buildDetailRow(Icons.fitness_center, 'Haftada 3 Gün', 'Spor Salonu / Sosyal Tesis Tespiti', isDark),
              ],
            ),
          ),
        ],
